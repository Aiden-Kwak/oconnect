...
function scrollFunction() {//스크롤될때 네비게이션이 어떻게 될지 보여주는 함수
...
function menuToggle() {//토글 버튼눌렀을때 호출되는 함수
...
var imageTimer = setInterval(imageSlideTimer, 3000);//3초마다 이동
...
function showImageSlides(n) {
    ...
    dots[imageSlideIndex - 1].className += ' actice';
}
